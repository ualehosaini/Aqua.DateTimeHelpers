...
namespace Aqua.DateTimeHelpers.Tests
{
    public class DateTimeHelpersTests
    {
        ...
        public void IsValidDate_Valid(bool expected, int year, int month, int day) => Assert.Equal(expected, DateTimeHelpers.IsValidDate(year, month, day));
        ...
        public void IsValidDateTime_Valid(bool expected, int year, int month, int day, int hour, int minute, int second = 0) => Assert.Equal(expected, DateTimeHelpers.IsValidDateTime(year, month, day, hour, minute, second));
        ...
        [Fact]
        public void IgnoreMilliseconds_Valid() => Assert.Equal(new DateTime(9999, 12, 31, 23, 59, 59), DateTime.MaxValue.IgnoreMilliseconds());
        ...
        [Fact]
        public void IgnoreHours_Valid() => Assert.Equal(new DateTime(9999, 12, 31, 0, 0, 0), DateTime.MaxValue.IgnoreHours());

        [Theory]
        [InlineData(true, 2019, 2, 10)]
        [InlineData(true, 2017, 10, 15)]
        [InlineData(false, 2019, 8, 15)]
        public void IsSunday_Valid(bool expected, int year, int month, int day) => Assert.Equal(expected, DateTimeHelpers.IsSunday(new DateTime(year, month, day)));

        [Theory]
        [InlineData(false, 2019, 2, 10)]
        [InlineData(false, 2017, 10, 15)]
        [InlineData(true, 2019, 8, 12)]
        public void IsMonday_Valid(bool expected, int year, int month, int day) => Assert.Equal(expected, DateTimeHelpers.IsMonday(new DateTime(year, month, day)));

        [Theory]
        [InlineData(false, 2019, 2, 10)]
        [InlineData(false, 2017, 10, 15)]
        [InlineData(true, 2019, 8, 13)]
        public void IsTuesday_Valid(bool expected, int year, int month, int day) => Assert.Equal(expected, DateTimeHelpers.IsTuesday(new DateTime(year, month, day)));

        [Theory]
        [InlineData(false, 2019, 2, 10)]
        [InlineData(false, 2017, 10, 15)]
        [InlineData(true, 2019, 8, 14)]
        public void IsWednesday_Valid(bool expected, int year, int month, int day) => Assert.Equal(expected, DateTimeHelpers.IsWednesday(new DateTime(year, month, day)));

        [Theory]
        [InlineData(false, 2019, 2, 10)]
        [InlineData(false, 2017, 10, 15)]
        [InlineData(true, 2019, 8, 15)]
        public void IsThursday_Valid(bool expected, int year, int month, int day) => Assert.Equal(expected, DateTimeHelpers.IsThursday(new DateTime(year, month, day)));

        [Theory]
        [InlineData(false, 2019, 2, 10)]
        [InlineData(false, 2017, 10, 15)]
        [InlineData(true, 2019, 8, 16)]
        public void IsFriday_Valid(bool expected, int year, int month, int day) => Assert.Equal(expected, DateTimeHelpers.IsFriday(new DateTime(year, month, day)));

        [Theory]
        [InlineData(false, 2019, 2, 10)]
        [InlineData(false, 2017, 10, 15)]
        [InlineData(true, 2019, 8, 17)]
        public void IsSaturday_Valid(bool expected, int year, int month, int day) => Assert.Equal(expected, DateTimeHelpers.IsSaturday(new DateTime(year, month, day)));
        ...
        public void GetFirstDayOfWeek_Valid(DateTime expected, DateTime dateTime) => Assert.Equal(expected, DateTimeHelpers.GetFirstDayOfWeek(dateTime));
        ...
        public void GetLastDayOfPreviousWeek_Valid(DateTime expected, DateTime dateTime) => Assert.Equal(expected, DateTimeHelpers.GetLastDayOfPreviousWeek(dateTime));
